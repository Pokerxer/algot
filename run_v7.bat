...
py ict_v7_mt5.py --symbols "GBPAUD,USDJPY,USDCHF,EURJPY,GBPJPY,NZDUSD,BTCUSD,ETHUSD,XRPUSD,SOLUSD" --mode live --login 298797826 --password "Pokerx_007" --server "Exness-MT5Trial9" --risk 0.02 --rr 3.0 --confluence 65 --max-loss 500 --reverse
