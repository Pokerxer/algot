"""
V3 Backtest - Forex Only + Confluence Filter
============================================
V3 strategy with:
...
def run_v3_forex_confluence(symbols, days=180, initial_capital=10000, risk_per_trade=0.02, confluence_threshold=60):
    """Run V3 forex backtest with V5 confluence filtering."""
    
    print(f"\n{'='*80}")
    print(f"ICT V3 Forex Backtest - V5 Confluence Filter (>= {confluence_threshold})")
    ...
    print(f"\n{'='*80}")
    print(f"V3 FOREX BACKTEST SUMMARY - IBKR + V5 Confluence (>= {confluence_threshold})")
    print(f"{'='*80}")
...
if __name__ == '__main__':
    forex_symbols = ['EURUSD', 'GBPUSD', 'USDJPY', 'AUDUSD', 'USDCAD', 'USDCHF', 'NZDUSD', 'GC', 'NQ', 'YM']
    
    results = run_v3_forex_confluence(
    ...
    if results:
        output_file = '/Users/mac/Documents/Algot/v3_forex_trades.json'
