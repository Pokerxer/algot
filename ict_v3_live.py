"""
ICT V3 - RL-Enhanced Live Trading System
=========================================
Ready for Alpaca paper trading on cloud.

Usage:
    python3 ict_v3_live.py --mode paper --symbols "NQ=F,GC=F,GBPUSD=X" --interval 30
"""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="ICT V3 Live Trading")
