"""
ICT V2 - 60 Day Backtest on NQ (Max 1 Contract)
"""
...
print("=" * 70)
print("ICT V2 - NQ 60 DAYS (MAX 1 CONTRACT)")
print("=" * 70)
...
print("Running simulation (max 1 contract)...")
...
for idx in range(50, len(df)):
    ...
    if open_trade is None and ai_filter_pass:
        ...
        if signal:
            size = MAX_CONTRACTS  # Fixed 1 contract
            open_trade = {
                'entry_idx': idx,
...
with open('v2_nq_1contract_trades.json', 'w') as f:
    json.dump(results, f, indent=2)

# Print summary
print()
print("=" * 70)
print("RESULTS - ICT V2 (MAX 1 CONTRACT)")
print("=" * 70)
...
print()
print(f"Trade data saved to: v2_nq_1contract_trades.json")
print("=" * 70)
